...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StartUpList = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StartUpList = function (_Component) {
		...
		function StartUpList(props, context) {
			...
			_this.state = {
				startups: [{ name: 'Plated', city: 'San Francisco', url: 'www.plated.com' }, { name: 'Amazon', city: 'Seattle', url: 'www.amazon.com' }, { name: 'Twitter', city: 'San Francisco', url: 'www.twitter.com' }, { name: 'Google', city: 'San Francisco', url: 'www.google.com' }]
			};
			return _this;
		}
		...
		_createClass(StartUpList, [{
			...
			value: function render() {
				var list = this.state.startups.map(function (startup, i) {
					return _react2.default.createElement(_ListItem2.default, { key: i, entity: startup });
				});
